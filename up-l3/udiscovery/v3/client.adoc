...
--
* *MUST* return a `UCode.NotFound` if no service matching the passed URI was found. 
--

[.specitem,oft-sid="dsn~discovery-findservices-error-invalid-argument~1",oft-needs="impl,test"]
--
* *MUST* return a `UCode.InvalidArgument` if: 
...
--
* *MUST* return a `UCode.PermissionDenied` if the caller is not permitted to query for that service.
--
...
--
* *MUST* return a `UCode.NotFound` if no topic matching the URI was found.
--

[.specitem,oft-sid="dsn~discovery-getservicetopics-error-invalid-argument~1",oft-needs="impl,test"]
--
* *MUST* return a `UCode.InvalidArgument` if the URI passed in is not a valid xref:../../../basics/uri.adoc[uProtocol UUri].
--

[.specitem,oft-sid="dsn~discovery-getservicetopics-error-permission-denied~1",oft-needs="impl,test"]
--
* *MUST* return a `UCode.PermissionDenied` if the caller is not permitted to query for that topic.
--
