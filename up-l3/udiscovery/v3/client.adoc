...
[.specitem,oft-sid="dsn~discovery-client-findservices-error-notfound~1",oft-needs="impl,test"]
--
...
[.specitem,oft-sid="dsn~discovery-client-getservicetopics-error-notfound~1",oft-needs="impl,test"]
--
